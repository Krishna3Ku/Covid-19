 ...
 *{margin:0;padding:0;box-sizing:border-box; font-family: 'Muli', sans-serif; }
   ...
   .row{margin-left:0!important; margin-right:0!important;}
	...
	.image6 img{ animation: corona 3s linear infinite;}
	.rightside h1 {font-size:3rem;}
	@keyframes corona{
    0% {transform:rotate(0);} 
	100%{transform:rotate(360deg);} 
	}
	.leftside img{ animation:image2 5s linear infinite;}
	 @keyframes image2{ 0%{transform:scale(.75);}20%{transform:scale(.75);}40%{transform:scale(1);}60%{transform:scale(.75);}80%{transform:scale(1);}100%{transform:scale(.75);}}
	 **************corona_update
	 .corona_update{
		margin: 0 0 30px 0; 
	 }
	...
	.sub_section{ background-color:#fafbfd;}
	.footer_style{ background-color:#aaafff!important;}
...
.count_content{display:inline!important;}
.count_content p{text-align:center;}
a_n{margin-left:0!important;}
